...
class AnsiTextRenderer extends BasicRenderer {
   ...
   protected $prefixes = [
      ...
      'access'        => self::ANSI_CODES['italic'],
      'class'         => self::ANSI_CODES['bold'] . self::ANSI_CODES['green_bri'],
      'constant'      => self::ANSI_CODES['green_bri'],
      'constant-type' => self::ANSI_CODES['italic'],
   ...
   protected $suffixes = [
      ...
      'constant'      => self::ANSI_CODES['reset'],
      'constant-type' => self::ANSI_CODES['reset'],
